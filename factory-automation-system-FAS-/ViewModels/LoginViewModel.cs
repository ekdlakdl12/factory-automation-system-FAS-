...
namespace factory_automation_system_FAS_.ViewModels
{
    public sealed class LoginViewModel : INotifyPropertyChanged
    {
        ...
        {
            // NOTE:
            // 현재 프로젝트의 RelayCommand는 CommandManager(RequerySuggested)와 연결되어 있지 않아
            // CanExecute 기반으로 버튼을 비활성화하면(Disabled) 입력 후에도 버튼이 갱신되지 않는
            // 상황이 발생할 수 있습니다.
            // MVP 단계에서는 로그인 버튼을 항상 활성화하고, DoLogin() 내부에서 입력/잠금 상태를 검증합니다.
